...
${notes ? `*Observações adicionais:* ${notes}` : ""}`;
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-slate-900 selection:bg-lime-100 selection:text-lime-900 pb-24 lg:pb-0">
      ...
      <a
        href="https://wa.me/5521964639999?text=Ol%C3%A1%21%20Vim%20pelo%20site%20da%20Dra.%20Alba%20Val%C3%A9ria%20e%20gostaria%20de%20ver%20como%20funciona%20para%20fechar%20a%20compra%20dele%20com%20voc%C3%AA."
        target="_blank"
        rel="noreferrer"
