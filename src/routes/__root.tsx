...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dra. Alba Valéria — Homeopatia & Medicina Integrativa | New Fashion" },
      { name: "description", content: "Medicina integrativa, homeopatia clássica e cuidado familiar há mais de 20 anos em Teresópolis. Atendimento afetuoso no New Fashion Shopping." },
      { property: "og:title", content: "Dra. Alba Valéria — Homeopata & Medicina Familiar" },
      { property: "og:description", content: "Uma medicina que olha para você por inteiro: cuidado natural e afeto há mais de 20 anos." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='#3f6212'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='white' font-family='sans-serif' font-weight='800' font-size='40'>AV</text></svg>" },
